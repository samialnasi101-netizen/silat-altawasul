 ...
 * Disabled by default. Set SETUP_ENABLED=true in .env to use.
 */
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ok: true,
      message: 'Admin user created. Log in with: admin / admin123. Change the password immediately and set SETUP_ENABLED=false.',
    });
  } catch (e) {
