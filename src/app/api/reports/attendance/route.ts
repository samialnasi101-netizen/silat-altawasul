...
export async function GET(req: Request) {
  try {
    ...
    // Saudi time = UTC+3, so Saudi midnight = UTC 21:00 previous day
    const start = new Date(Date.UTC(year, month - 1, 1, -3, 0, 0, 0)); // Day 1 00:00 Saudi
    const end = new Date(Date.UTC(year, month, 0, 20, 59, 59, 999)); // Last day 23:59 Saudi
